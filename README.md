...
jobs:
  backport:
    ...
    steps:
      - name: Run backport
        uses: step-security/backport-github-action@v12
        with:
...
See the [Backport Tool documentation](https://github.com/sorenlouv/backport/blob/main/docs/configuration.md) for all configuration options.
